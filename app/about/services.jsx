 ...
 return (
        <div className='mt-10'>
          ...
          <div className="flex flex-wrap justify-center gap-10">
              <div data-aos="fade-up" className="w-96 shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] text-justify p-4 rounded-md mx-2 hover:bg-sky-200 group cursor-pointer transition duration-500 hover:duration-500 ease-in-out">
                ...
                <div>
                  <h3 className="font-medium text-xl text-sky-500">
                     Web Development
                  </h3>
                    <p className="mt-1 text-gray-700 group-hover:text-white group-hover:duration-500 duration-500">Passionate web developer with a knack for creating dynamic,
                     user-friendly websites using modern technologies and best practices.
                    </p>
                </div>
              </div>

              <div data-aos="fade-up" className="w-96 shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] text-justify p-4 rounded-md mx-2 group hover:bg-green-200 cursor-pointer transition duration-500 hover:duration-500 ease-in-out">
                ...
                <div>
                  ...
                  <p className="mt-1 text-gray-700 group-hover:text-white group-hover:duration-500 duration-500">
              ...
              <div data-aos="fade-up" className="w-96 shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] text-justify p-4 rounded-md mx-2 hover:bg-indigo-200 group cursor-pointer transition duration-500 hover:duration-500 ease-in-outr">
