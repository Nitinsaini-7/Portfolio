  ...
  return (
    <div>
      ...
      <div className="flex items-center my-10 lg:mx-96">
        ...
        <h1 className="px-3 text-black font-medium text-4xl">Contact Us</h1>
        <div className="border-t border-2 border-orange-400 flex-grow"></div>
      </div>

      <section className="bg-white dark:bg-gray-900 mx-5 m-1 md:mx-20 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
        <div className="container px-6 mx-auto py-10">
          <div className="grid grid-cols-1 gap-12  lg:grid-cols-2">
            <div className="">
              <div className="text-center">

                <h1 className="mt-2 uppercase text-2xl font-semibold text-orange-400">
                Let's Get Started
                </h1>
              ...
              <div className="grid grid-cols-1 gap-10 md:grid-cols-1 place-items-center mt-2 md:mt-20">
                <div className="grid grid-cols-1 place-items-center">
                  <span className="inline-block cursor-pointer p-3 text-orange-400 rounded-full bg-orange-200 dark:bg-gray-800">
                    <svg
                  ...
                  <p className="mt-2 cursor-pointer text-sm text-orange-400 ">
